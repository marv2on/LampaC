...
namespace Shared.Services
{
    public class HttpHydra
    {
        ...
        #region Get
        public Task<T> Get<T>(string url, List<HeadersModel> addheaders = null, List<HeadersModel> newheaders = null, bool useDefaultHeaders = true, bool statusCodeOK = true, Encoding encoding = default, bool IgnoreDeserializeObject = false, bool safety = false, bool textJson = false)
        {
            ...
            return IsRchEnable(safety)
                ...
                : Http.Get<T>(init.cors(url, headers, requestInfo), null, null, 0, init.httptimeout, headers, IgnoreDeserializeObject, proxy, statusCodeOK, init.httpversion, useDefaultHeaders: useDefaultHeaders, httpClient: httpClient, textJson: textJson);
        }
        ...
        public Task<string> Get(string url, List<HeadersModel> addheaders = null, List<HeadersModel> newheaders = null, bool useDefaultHeaders = true, bool statusCodeOK = true, Encoding encoding = default, bool safety = false)
        {
            ...
            return IsRchEnable(safety)
                ...
                : Http.Get(init.cors(url, headers, requestInfo), encoding, null, null, init.httptimeout, headers, 0, proxy, init.httpversion, statusCodeOK, useDefaultHeaders: useDefaultHeaders, httpClient: httpClient);
        }
        #endregion
        ...
        public Task GetSpan(string url, Action<ReadOnlySpan<char>> spanAction, List<HeadersModel> addheaders = null, List<HeadersModel> newheaders = null, bool useDefaultHeaders = true, bool statusCodeOK = true, bool safety = false)
        {
            ...
            return IsRchEnable(safety)
                ...
                : Http.GetSpan(init.cors(url, headers, requestInfo), spanAction, default, null, null, 0, init.httptimeout, headers, proxy, statusCodeOK, init.httpversion, useDefaultHeaders: useDefaultHeaders, httpClient: httpClient);
        }
        #endregion


        #region Post
        public Task<T> Post<T>(string url, string data, List<HeadersModel> addheaders = null, List<HeadersModel> newheaders = null, bool useDefaultHeaders = true, bool statusCodeOK = true, Encoding encoding = default, bool IgnoreDeserializeObject = false, bool safety = false, bool textJson = false)
        {
            var headers = JsonHeaders(addheaders, newheaders);

            return IsRchEnable(safety)
                ? rch.Post<T>(init.cors(url, headers, requestInfo), data, headers, IgnoreDeserializeObject, useDefaultHeaders, textJson)
                : Http.Post<T>(init.cors(url, headers, requestInfo), data, null, init.httptimeout, headers, encoding, proxy, IgnoreDeserializeObject, null, useDefaultHeaders, init.httpversion, 0, statusCodeOK, httpClient, textJson);
        }
        ...
        public Task<string> Post(string url, string data, List<HeadersModel> addheaders = null, List<HeadersModel> newheaders = null, bool useDefaultHeaders = true, bool statusCodeOK = true, Encoding encoding = default, bool safety = false)
        {
            ...
            return IsRchEnable(safety)
                ...
                : Http.Post(init.cors(url, headers, requestInfo), data, null, 0, init.httptimeout, headers, proxy, init.httpversion, null, useDefaultHeaders, false, encoding, statusCodeOK, httpClient);
        }
        #endregion
        ...
        public Task PostSpan(string url, string data, Action<ReadOnlySpan<char>> spanAction, List<HeadersModel> addheaders = null, List<HeadersModel> newheaders = null, bool useDefaultHeaders = true, bool statusCodeOK = true, Encoding encoding = default, bool safety = false)
        {
            ...
            return IsRchEnable(safety)
                ...
                : Http.PostSpan(init.cors(url, headers, requestInfo), spanAction, data, null, init.httptimeout, headers, encoding, proxy, null, useDefaultHeaders, init.httpversion, 0, statusCodeOK, httpClient);
        }
        #endregion
