using Online.Models.Redheadsound;
...
namespace Online.Services
{
    public struct RedheadsoundInvoke
    {
        ...
        public RedheadsoundInvoke(string host, string apihost, Func<string, Task<string>> onget, Func<string, string, Task<string>> onpost, Func<string, string> onstreamfile)
        {
