...
namespace Online.Services
{
    public class FilmixTVInvoke
    {
        ...
        async public Task<SearchResult> Search(string title, string original_title, int clarification, int year, bool similar)
        {
            ...
            var root = await httpHydra.Get<Models.FilmixTV.RootObject>(uri, addheaders: bearer, safety: true);
        ...
        #region Post
        public Models.FilmixTV.RootObject Post(string json)
        {
            ...
            try
            {
                var rootMs = new Models.FilmixTV.RootObject();
        ...
        #region Tpl
        public ITplResult Tpl(Models.FilmixTV.RootObject root, bool pro, int postid, string title, string original_title, int t, int? s, VastConf vast = null)
        {
            if (root == null)
                return default;
