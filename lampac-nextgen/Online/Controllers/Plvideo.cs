...
using Online.Models.Plvideo;

namespace Online.Controllers
{
    public class Plvideo : BaseOnlineController
    {
        public Plvideo() : base(ModInit.siteConf.Plvideo) { }
        ...
        async public Task<ActionResult> Movie(string linkid)
        {
            ...
            return ContentTo(VideoTpl.ToJson("play", first.link, first.quality, streamquality: streams, vast: init.vast));
        }
    }
}
