...
namespace JacRed.Engine
{
    ...
    {
        static readonly Serilog.ILogger Log = Serilog.Log.ForContext<FileDB>();
        ...
        public static void SaveChangesToFile()
        {
            ...
            {
                Log.Error(ex, "CatchId={CatchId}", "id_loyfo24h");
            }
        }
        #endregion
        ...
        async public static Task Cron()
        {
            while (!ModInit.IsDispose)
            {
                ...
                {
                    Log.Error(ex, "CatchId={CatchId}", "id_aekguy4s");
                }
            }
        }
        ...
        async public static Task CronFast()
        {
            while (!ModInit.IsDispose)
            {
                ...
                {
                    Log.Error(ex, "CatchId={CatchId}", "id_jeckyzu1");
                }
            }
        }
        #endregion
