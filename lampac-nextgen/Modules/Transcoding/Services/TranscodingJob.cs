...
namespace Transcoding.Services
{
    ...
    {
        static readonly Serilog.ILogger Log = Serilog.Log.ForContext<TranscodingJob>();
        ...
        public void Dispose()
        {
            ...
            {
                Log.Error(ex, "CatchId={CatchId}", "id_p5i63hde");
            }
            ...
            {
                Log.Error(ex, "CatchId={CatchId}", "id_6fb2ahbb");
            }
        }
    }
}
